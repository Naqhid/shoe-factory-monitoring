...
CREATE TABLE `machine_centre_production` (
  ...
  KEY `idx_work_centre` (`work_centre_id`),
  KEY `idx_status` (`button_status`)
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Raw production entries - per 12 pairs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Summary/Pivot table aggregated from machine_centre_production';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `machine_centre_summary` (`id`, `prod_date`, `work_centre_id`, `machine_id`, `emp_id`, `total_output_pairs`, `total_target_mins`, `total_actual_mins`, `total_idle_mins`, `cum_avg_time`, `button_status`, `created_at`, `updated_at`) VALUES (25,'2026-04-11',5,'01','278',156,215.80,8.90,0.72,0.00,2,'2026-04-11 06:17:06','2026-04-11 11:17:29'),(26,'2026-04-11',5,'02','709',24,33.20,0.41,32.28,0.00,2,'2026-04-11 06:17:20','2026-04-11 11:21:30'),(27,'2026-04-11',5,'03','724',12,16.60,0.07,0.00,0.00,2,'2026-04-11 06:17:31','2026-04-11 06:17:31'),(28,'2026-04-11',5,'04','580',12,16.60,0.08,0.00,0.00,2,'2026-04-11 06:17:44','2026-04-11 06:17:44'),(29,'2026-04-11',5,'05','108',12,16.60,0.15,0.00,0.00,2,'2026-04-11 06:18:03','2026-04-11 06:18:03'),(30,'2026-04-11',5,'06','346',12,16.60,0.10,0.00,0.00,2,'2026-04-11 06:18:25','2026-04-11 06:18:25'),(31,'2026-04-11',5,'07','85',12,16.60,0.10,0.00,0.00,2,'2026-04-11 06:18:39','2026-04-11 06:18:39'),(34,'2026-04-11',5,'TEST-01','278',12,16.60,33.20,0.00,0.00,2,'2026-04-11 10:02:35','2026-04-11 10:02:35'),(35,'2026-04-11',5,'TEST-02','709',12,16.60,22.13,0.00,0.00,2,'2026-04-11 10:02:35','2026-04-11 10:02:35');
...
-- Dump completed on 2026-04-11 17:00:06
