...
CREATE TABLE `machine_centre_production` (
  ...
  KEY `idx_work_centre` (`work_centre_id`),
  KEY `idx_status` (`button_status`)
) ENGINE=InnoDB AUTO_INCREMENT=97 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Raw production entries - per 12 pairs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Summary/Pivot table aggregated from machine_centre_production';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `machine_centre_summary` (`id`, `prod_date`, `work_centre_id`, `machine_id`, `emp_id`, `total_output_pairs`, `total_target_mins`, `total_actual_mins`, `total_idle_mins`, `cum_avg_time`, `button_status`, `created_at`, `updated_at`) VALUES (64,'2026-04-16',5,'06','724',72,191.05,111.98,0.00,0.00,2,'2026-04-16 04:08:05','2026-04-16 10:12:12'),(65,'2026-04-16',5,'01','165',120,368.50,196.48,0.00,0.00,2,'2026-04-16 04:10:00','2026-04-16 10:20:09');
...
INSERT INTO `mobile_sessions` VALUES ('1cffe817-d7d7-45f5-a61c-bd26cfb3ec71','06','active',5,5,'724','2026-04-11 06:06:47','2026-04-16 03:45:05'),('245f14b4-dbe3-4b08-aa7a-3d920f8776ec','05','active',5,6,'108','2026-04-11 06:06:15','2026-04-11 06:06:15'),('3338ac1b-9176-45cb-b64a-40edb79f075e','04','active',5,8,'580','2026-04-11 06:05:33','2026-04-11 06:05:33'),('41da75f2-b9ca-4ce8-a41f-d1388a34ccb3','01','active',5,11,'165','2026-04-09 09:13:51','2026-04-16 03:46:30'),('af3fa881-3743-4bc8-9345-7bd25eee1d09','03','active',5,4,'85','2026-04-11 06:04:58','2026-04-14 10:42:23'),('da74b0b1-7bf5-4660-9c98-021d2ae848c1','07','active',5,9,'709','2026-04-11 06:07:25','2026-04-14 05:15:42'),('eef3fb56-07aa-4003-ac61-2179f8d27a77','02','active',5,7,'346','2026-04-10 06:16:31','2026-04-14 05:06:01'),('fbd045ca-efb2-40ae-9d17-cbf334de6845','MAC-001','active',4,1,'EMP-1001','2026-03-23 09:35:36','2026-04-08 05:33:17');
...
-- Dump completed on 2026-04-16 17:00:05
