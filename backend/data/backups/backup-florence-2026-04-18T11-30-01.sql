...
CREATE TABLE `machine_centre_production` (
  ...
  KEY `idx_work_centre` (`work_centre_id`),
  KEY `idx_status` (`button_status`)
) ENGINE=InnoDB AUTO_INCREMENT=155 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Raw production entries - per 12 pairs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=128 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Summary/Pivot table aggregated from machine_centre_production';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `machine_centre_summary` (`id`, `prod_date`, `work_centre_id`, `machine_id`, `emp_id`, `total_output_pairs`, `total_target_mins`, `total_actual_mins`, `total_idle_mins`, `cum_avg_time`, `button_status`, `created_at`, `updated_at`) VALUES (104,'2026-04-18',5,'01','165',108,268.29,225.54,0.00,0.00,2,'2026-04-18 03:45:09','2026-04-18 11:21:35'),(106,'2026-04-18',5,'06','724',108,253.35,200.59,0.00,0.00,2,'2026-04-18 04:36:49','2026-04-18 10:14:21');
...
INSERT INTO `mobile_sessions` VALUES ('1cffe817-d7d7-45f5-a61c-bd26cfb3ec71','06','active',5,5,'724','2026-04-11 06:06:47','2026-04-18 03:42:43'),('245f14b4-dbe3-4b08-aa7a-3d920f8776ec','05','active',5,6,'108','2026-04-11 06:06:15','2026-04-11 06:06:15'),('3338ac1b-9176-45cb-b64a-40edb79f075e','04','active',5,8,'580','2026-04-11 06:05:33','2026-04-11 06:05:33'),('41da75f2-b9ca-4ce8-a41f-d1388a34ccb3','01','active',5,11,'165','2026-04-09 09:13:51','2026-04-18 03:40:21'),('af3fa881-3743-4bc8-9345-7bd25eee1d09','03','active',5,4,'85','2026-04-11 06:04:58','2026-04-14 10:42:23'),('da74b0b1-7bf5-4660-9c98-021d2ae848c1','07','active',5,9,'709','2026-04-11 06:07:25','2026-04-14 05:15:42'),('eef3fb56-07aa-4003-ac61-2179f8d27a77','02','active',5,7,'346','2026-04-10 06:16:31','2026-04-14 05:06:01'),('fbd045ca-efb2-40ae-9d17-cbf334de6845','MAC-001','active',4,1,'EMP-1001','2026-03-23 09:35:36','2026-04-08 05:33:17');
...
INSERT INTO `production_routing_header` (`id`, `customer_id`, `group_id`, `leather_id`, `style_id`, `color_id`, `created_on`, `category`, `target_per_day`, `tot_smv`, `created_at`, `updated_at`) VALUES (25,1,1,1,1,1,'2026-04-04','Attaching',210,68.7800,'2026-04-09 06:55:07','2026-04-18 04:24:46');
...
INSERT INTO `production_routing_lines` (`id`, `routing_header_id`, `machine_centre_id`, `process`, `observed_time`, `rating_factor`, `manpower`, `created_at`, `updated_at`) VALUES (92,25,'01','Eyelet Attaching',144.00,90.00,1.00,'2026-04-18 04:24:46','2026-04-18 04:24:46'),(93,25,'02','Toe Attaching',150.00,90.00,1.00,'2026-04-18 04:24:46','2026-04-18 04:24:46'),(94,25,'03','Heelgrip attaching + collar attaching',167.00,90.00,1.00,'2026-04-18 04:24:46','2026-04-18 04:24:46'),(95,25,'04','Folding',160.00,90.00,1.00,'2026-04-18 04:24:46','2026-04-18 04:24:46'),(96,25,'05','Final Stitching',60.00,90.00,1.00,'2026-04-18 04:24:46','2026-04-18 04:24:46'),(97,25,'06','Counter Attaching',136.00,90.00,1.00,'2026-04-18 04:24:46','2026-04-18 04:24:46'),(98,25,'07','Eol Final Inspection',50.00,90.00,1.00,'2026-04-18 04:24:46','2026-04-18 04:24:46');
...
-- Dump completed on 2026-04-18 17:00:07
