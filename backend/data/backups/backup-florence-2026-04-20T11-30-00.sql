...
CREATE TABLE `machine_centre_production` (
  ...
  KEY `idx_work_centre` (`work_centre_id`),
  KEY `idx_status` (`button_status`)
) ENGINE=InnoDB AUTO_INCREMENT=211 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Raw production entries - per 12 pairs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=187 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Summary/Pivot table aggregated from machine_centre_production';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `machine_centre_summary` (`id`, `prod_date`, `work_centre_id`, `machine_id`, `emp_id`, `total_output_pairs`, `total_target_mins`, `total_actual_mins`, `total_idle_mins`, `cum_avg_time`, `button_status`, `created_at`, `updated_at`) VALUES (143,'2026-04-20',5,'01','165',156,384.31,277.91,0.00,1.78,2,'2026-04-20 05:08:24','2026-04-20 10:37:01'),(144,'2026-04-20',5,'06','724',168,394.20,298.34,0.00,1.78,2,'2026-04-20 05:08:24','2026-04-20 10:58:13'),(180,'2026-04-20',5,'03','278',24,65.62,30.30,0.00,1.26,2,'2026-04-20 10:22:05','2026-04-20 11:04:45');
...
-- Dump completed on 2026-04-20 17:00:01
