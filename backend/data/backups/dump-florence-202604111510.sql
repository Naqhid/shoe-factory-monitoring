...
CREATE TABLE `machine_centre_production` (
  ...
  KEY `idx_work_centre` (`work_centre_id`),
  KEY `idx_status` (`button_status`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Raw production entries - per 12 pairs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Summary/Pivot table aggregated from machine_centre_production';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `machine_centre_summary` (`id`, `prod_date`, `work_centre_id`, `machine_id`, `emp_id`, `total_output_pairs`, `total_target_mins`, `total_actual_mins`, `total_idle_mins`, `cum_avg_time`, `button_status`, `created_at`, `updated_at`) VALUES (25,'2026-04-11',5,'01','278',12,16.60,0.17,0.00,0.00,2,'2026-04-11 06:17:06','2026-04-11 06:17:06'),(26,'2026-04-11',5,'02','709',12,16.60,0.08,0.00,0.00,2,'2026-04-11 06:17:20','2026-04-11 06:17:20'),(27,'2026-04-11',5,'03','724',12,16.60,0.07,0.00,0.00,2,'2026-04-11 06:17:31','2026-04-11 06:17:31'),(28,'2026-04-11',5,'04','580',12,16.60,0.08,0.00,0.00,2,'2026-04-11 06:17:44','2026-04-11 06:17:44'),(29,'2026-04-11',5,'05','108',12,16.60,0.15,0.00,0.00,2,'2026-04-11 06:18:03','2026-04-11 06:18:03'),(30,'2026-04-11',5,'06','346',12,16.60,0.10,0.00,0.00,2,'2026-04-11 06:18:25','2026-04-11 06:18:25'),(31,'2026-04-11',5,'07','85',12,16.60,0.10,0.00,0.00,2,'2026-04-11 06:18:39','2026-04-11 06:18:39');
...
INSERT INTO `machine_centres` VALUES (10,5,'05','Latex Spraying','Final Stitching','05','2026-04-08 03:55:33','2026-04-10 09:52:38'),(11,5,'06','Eyelet punching and clouching','Counter Attaching','06','2026-04-08 04:02:56','2026-04-10 09:52:38'),(12,5,'07','Trimming','Eol Final Inspection','07','2026-04-08 04:03:31','2026-04-10 09:52:38'),(13,5,'02','Folding','Toe Attaching','02','2026-04-08 04:04:35','2026-04-10 09:52:39'),(14,5,'03','Stiching','Hand stitching','03','2026-04-08 04:05:06','2026-04-10 09:52:39'),(18,5,'01','Attaching','Eyelet Attaching','01','2026-04-08 08:07:43','2026-04-11 05:45:24'),(19,5,'04','MIC Operator','Folding','04','2026-04-08 11:14:37','2026-04-10 09:52:39');
...
INSERT INTO `mobile_sessions` VALUES ('1cffe817-d7d7-45f5-a61c-bd26cfb3ec71','06','active',5,7,'346','2026-04-11 06:06:47','2026-04-11 06:06:47'),('245f14b4-dbe3-4b08-aa7a-3d920f8776ec','05','active',5,6,'108','2026-04-11 06:06:15','2026-04-11 06:06:15'),('3338ac1b-9176-45cb-b64a-40edb79f075e','04','active',5,8,'580','2026-04-11 06:05:33','2026-04-11 06:05:33'),('41da75f2-b9ca-4ce8-a41f-d1388a34ccb3','01','active',5,3,'278','2026-04-09 09:13:51','2026-04-11 05:26:10'),('af3fa881-3743-4bc8-9345-7bd25eee1d09','03','active',5,5,'724','2026-04-11 06:04:58','2026-04-11 06:04:58'),('da74b0b1-7bf5-4660-9c98-021d2ae848c1','07','active',5,4,'85','2026-04-11 06:07:25','2026-04-11 06:07:25'),('eef3fb56-07aa-4003-ac61-2179f8d27a77','02','active',5,9,'709','2026-04-10 06:16:31','2026-04-11 06:04:08'),('fbd045ca-efb2-40ae-9d17-cbf334de6845','MAC-001','active',4,1,'EMP-1001','2026-03-23 09:35:36','2026-04-08 05:33:17');
...
INSERT INTO `production_alerts` VALUES (1,'efficiency_low','critical',5,'01','2026-04-11','Machine 01 efficiency critically low at 42% (threshold: 50%)',50.00,42.00,0,'2026-04-11 15:05:34'),(2,'efficiency_low','warning',5,'02','2026-04-11','Machine 02 efficiency below target at 65% (threshold: 70%)',70.00,65.00,0,'2026-04-11 15:05:34'),(3,'headcount_low','warning',5,NULL,'2026-04-11','Work centre headcount low: 3 present vs 7 target (42%)',7.00,3.00,0,'2026-04-11 15:05:34'),(4,'target_at_risk','critical',5,NULL,'2026-04-11','Daily target at risk: 48 / 200 pairs produced (24%)',200.00,48.00,0,'2026-04-11 15:05:34'),(5,'target_at_risk','warning',5,NULL,'2026-04-11','Daily target at risk: 130 / 200 pairs produced (65%)',200.00,130.00,0,'2026-04-11 15:05:34');
...
INSERT INTO `production_plan` VALUES (6,'2026-04-11',1,1,1,1,1,5,210,12,18,3,68.7800,'2026-04-09 11:24:58','2026-04-11 06:19:05');
...
-- Dump completed on 2026-04-11 15:10:16
