...
CREATE TABLE `machine_centre_production` (
  ...
  KEY `idx_work_centre` (`work_centre_id`),
  KEY `idx_status` (`button_status`)
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Raw production entries - per 12 pairs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Summary/Pivot table aggregated from machine_centre_production';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `machine_centre_summary` (`id`, `prod_date`, `work_centre_id`, `machine_id`, `emp_id`, `total_output_pairs`, `total_target_mins`, `total_actual_mins`, `total_idle_mins`, `cum_avg_time`, `button_status`, `created_at`, `updated_at`) VALUES (50,'2026-04-14',5,'01','346',60,83.00,1.22,0.00,0.00,2,'2026-04-14 05:02:25','2026-04-14 05:25:37'),(55,'2026-04-14',5,'02','346',12,16.60,0.08,0.00,0.00,2,'2026-04-14 05:55:12','2026-04-14 05:55:12'),(57,'2026-04-14',7,'12','E001',20,100.00,120.00,40.00,10.00,1,'2026-04-14 07:49:56','2026-04-14 07:49:56');
...
INSERT INTO `machine_centres` VALUES (10,5,'05','Final Stitching','Final Stitching','05','2026-04-08 03:55:33','2026-04-14 06:23:02'),(11,5,'06','Counter Attaching','Counter Attaching','06','2026-04-08 04:02:56','2026-04-14 06:23:02'),(12,5,'07','Eol Final Inspection','Eol Final Inspection','07','2026-04-08 04:03:31','2026-04-14 06:23:02'),(13,5,'02','Toe Attaching','Toe Attaching','02','2026-04-08 04:04:35','2026-04-14 06:23:02'),(14,5,'03','Heelgrip attaching + collar attaching','Heelgrip attaching + collar attaching','03','2026-04-08 04:05:06','2026-04-14 05:56:23'),(18,5,'01','Eyelet Attaching','Eyelet Attaching','01','2026-04-08 08:07:43','2026-04-14 06:23:02'),(19,5,'04','Folding','Folding','04','2026-04-08 11:14:37','2026-04-14 06:23:02'),(20,7,'12','Test Machine','Test Machine','12','2026-04-14 07:23:54','2026-04-14 07:24:30');
...
INSERT INTO `mobile_sessions` VALUES ('1cffe817-d7d7-45f5-a61c-bd26cfb3ec71','06','active',5,7,'346','2026-04-11 06:06:47','2026-04-11 06:06:47'),('245f14b4-dbe3-4b08-aa7a-3d920f8776ec','05','active',5,6,'108','2026-04-11 06:06:15','2026-04-11 06:06:15'),('3338ac1b-9176-45cb-b64a-40edb79f075e','04','active',5,8,'580','2026-04-11 06:05:33','2026-04-11 06:05:33'),('41da75f2-b9ca-4ce8-a41f-d1388a34ccb3','01','active',5,7,'346','2026-04-09 09:13:51','2026-04-14 05:01:20'),('af3fa881-3743-4bc8-9345-7bd25eee1d09','03','active',5,5,'724','2026-04-11 06:04:58','2026-04-11 06:04:58'),('da74b0b1-7bf5-4660-9c98-021d2ae848c1','07','active',5,4,'85','2026-04-11 06:07:25','2026-04-11 06:07:25'),('eef3fb56-07aa-4003-ac61-2179f8d27a77','02','active',5,7,'346','2026-04-10 06:16:31','2026-04-14 05:06:01'),('fbd045ca-efb2-40ae-9d17-cbf334de6845','MAC-001','active',4,1,'EMP-1001','2026-03-23 09:35:36','2026-04-08 05:33:17');
...
INSERT INTO `production_alerts` VALUES (1,'efficiency_low','critical',5,'01','2026-04-11','Machine 01 efficiency critically low at 42% (threshold: 50%)',50.00,42.00,1,'2026-04-11 15:05:34'),(2,'efficiency_low','warning',5,'02','2026-04-11','Machine 02 efficiency below target at 65% (threshold: 70%)',70.00,65.00,1,'2026-04-11 15:05:34'),(3,'headcount_low','warning',5,NULL,'2026-04-11','Work centre headcount low: 3 present vs 7 target (42%)',7.00,3.00,1,'2026-04-11 15:05:34'),(4,'target_at_risk','critical',5,NULL,'2026-04-11','Daily target at risk: 48 / 200 pairs produced (24%)',200.00,48.00,1,'2026-04-11 15:05:34'),(5,'target_at_risk','warning',5,NULL,'2026-04-11','Daily target at risk: 130 / 200 pairs produced (65%)',200.00,130.00,1,'2026-04-11 15:05:34'),(8,'efficiency_low','warning',5,'TEST-01','2026-04-11','Machine TEST-01 efficiency below target at 50.0% (threshold: 70%)',70.00,50.00,1,'2026-04-11 15:32:35'),(9,'headcount_low','warning',5,NULL,'2026-04-14','Work centre headcount low: 1 present vs 15.80 target (6%)',15.80,1.00,0,'2026-04-14 11:31:52'),(10,'target_at_risk','critical',5,NULL,'2026-04-14','Daily target at risk: 72 / 420 pairs produced (17%)',420.00,72.00,0,'2026-04-14 11:31:52'),(11,'efficiency_low','warning',1,'03','2026-04-14','Machine 03 efficiency below target at 62.5% (threshold: 70%)',70.00,62.50,0,'2026-04-14 12:45:08'),(12,'efficiency_low','warning',7,'12','2026-04-14','Machine 12 efficiency below target at 62.5% (threshold: 70%)',70.00,62.50,0,'2026-04-14 13:19:56');
...
INSERT INTO `production_plan` VALUES (8,'2026-04-14',1,1,1,1,1,5,210,12,18,15,68.7800,'2026-04-14 06:58:01','2026-04-14 06:58:01');
...
INSERT INTO `production_routing_header` (`id`, `customer_id`, `group_id`, `leather_id`, `style_id`, `color_id`, `created_on`, `category`, `target_per_day`, `tot_smv`, `created_at`, `updated_at`) VALUES (25,1,1,1,1,1,'2026-04-10','Attaching',210,68.7800,'2026-04-09 06:55:07','2026-04-10 04:18:43');
...
INSERT INTO `production_routing_lines` (`id`, `routing_header_id`, `machine_centre_id`, `process`, `observed_time`, `rating_factor`, `manpower`, `created_at`, `updated_at`) VALUES (50,25,'01','Eyelet Attaching',85.00,90.00,1.00,'2026-04-14 06:31:58','2026-04-14 07:02:59'),(51,25,'02','Toe Attaching',115.00,90.00,1.00,'2026-04-14 06:31:58','2026-04-14 07:03:03'),(52,25,'03','Heelgrip attaching + collar attaching',100.00,90.00,1.00,'2026-04-14 06:31:58','2026-04-14 07:03:07'),(53,25,'04','Folding',95.00,90.00,1.00,'2026-04-14 06:31:58','2026-04-14 07:03:11'),(54,25,'05','Final Stitching',130.00,90.00,1.00,'2026-04-14 06:31:58','2026-04-14 07:03:15'),(55,25,'06','Counter Attaching',110.00,90.00,1.00,'2026-04-14 06:31:58','2026-04-14 07:03:18'),(56,25,'07','Eol Final Inspection',70.00,90.00,1.00,'2026-04-14 06:31:58','2026-04-14 07:03:22');
...
INSERT INTO `work_centres` VALUES (5,'Stitching-line','Line 2A','2026-04-09 07:06:28','2026-04-11 06:01:19'),(7,'Test-001','Test','2026-04-10 06:26:02','2026-04-10 06:26:02');
...
-- Dump completed on 2026-04-14 13:22:14
